...
namespace BFL
{
  ...
  //  enum class SampleMthd { DEFAULT, BOXMULLER, CHOLESKY, RIPLEY }; //new version
  ...
  class NonlinearSystemPdf : public ConditionalPdf<MatrixWrapper::ColumnVector, MatrixWrapper::ColumnVector>
    ...
    public:
      ...
      */
      ...
      //
      virtual bool SampleFrom (Sample<MatrixWrapper::ColumnVector>& one_sample, const int method=DEFAULT, void * args=NULL) const;
